...
//        double highValDouble;
    ...
    public:
         ...
         * @throws  BadScanrangeException If lowVal > highval
          ...
          **/
        const void
        startScan(const void *lowValParm, const Operator lowOpParm, const void *highValParm, const Operator highOpParm);
        ...
        const void insertRecur(Page *curPage, PageId curPageNum, bool nodeIsLeaf, const RIDKeyPair<int> dataEntry,
                          PageKeyPair<int> *&newchildEntry);

        PageId initialPageNum;
    };
